...
public class SplashScreen implements Screen {
	...
	TextureRegion splashTextureRegion = new TextureRegion(splashTexture, 0, 0, 512, 364);
	...
	// FADE IN WITH REPEAT
	Tween.to(splashSprite, SpriteAccessor.ALPHA, 1.5f).target(1).repeatYoyo(1, 1.5f).setCallback(new TweenCallback() {
